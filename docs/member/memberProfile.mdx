...
- [Job Ready Status](../admins/course/job-ready#job-ready-status)
- Login count
...
The **Courses Tab** also gives you the ability to [share your coures certifications](cert-share#qrcode) or [print proof of training](cert-share#print)
:::
